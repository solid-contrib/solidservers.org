...
3) Although Inrupt ESS does have a WAC module, this feature is disabled on pod.inrupt.com and [not supported in production](https://docs.inrupt.com/ess/latest/security/authorization/#additional-information)
